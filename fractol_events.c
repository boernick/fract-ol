...
/*   Updated: 2024/09/22 16:45:25 by nboer            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static int	handle_mods(int keycode, t_fractol *frac)
{
...
static int	handle_view(int keycode, t_fractol *frac)
{
...
static int	handle_hotspots(int keycode, t_fractol *frac)
{
	if (keycode == XK_1)
	{
		frac->zoom = 0.008728;
